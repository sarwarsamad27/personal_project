...
class Global {
  ...
  static var ChangeLoggedInPassword = "${BaseUrl}/change-password";
  ...
  static var GetAllOrdersAnyStatus = "${BaseUrl}/get/orders/all";
  ...
  static var removeFcmToken = "${BaseUrl}/seller/remove/fcm-token";
  ...
  static var BulkAcceptOrders = "${BaseUrl}/accept/orders/bulk";
  ...
  static String leopardsSyncAllOrders =
      "${BaseUrl}/company/order/sync-leopards";
